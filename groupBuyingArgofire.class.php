...
class Group_Buying_ArgoFire extends Group_Buying_Credit_Card_Processors {
	const API_ENDPOINT_SANDBOX = 'https://dev.ftipgw.com/smartpayments/transact.asmx';
	const API_ENDPOINT_LIVE = 'https://secure.ftipgw.com/smartpayments/transact.asmx/';
	...
	public static function register() {
		self::add_payment_processor(__CLASS__, self::__('Bluepay'));
	}
	...
	private function aim_data( Group_Buying_Checkouts $checkout, Group_Buying_Purchase $purchase ) {
		...
		$AIMdata = apply_filters('gb_argofire_nvp_data', $AIMdata); 
	...
	public function register_settings() {
		...
		add_settings_field(self::API_USERNAME_OPTION, self::__('Partner/ResellerKey'), array($this, 'display_api_vendor_field'), $page, $section);
		add_settings_field(self::API_USERNAME_OPTION, self::__('Vendor/MerchantKey/RPNum'), array($this, 'display_api_merchant_field'), $page, $section);
